...
>
> When I came across the statement, `The initial assessment stated that the project was relatively small and therefore a suitable candidate for a rewrite`, it immediately triggered this journal entry. If we had engineered the solution correctly the first time, we would not be in a rewrite situation at all. It is evidence of inadequate engineering discipline in the original build - with disregard to our guardrails.
>
