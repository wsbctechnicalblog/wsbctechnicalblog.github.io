...
Summary: A Practical Reference for Collaboration with Willy.
...
When I look at a proposal (or ask [agent ubuntu](/zero-or-one-not-fault-lines-2029-ubuntu-vision.html) to analyse), an architecture, or automation, my first question is: 
...
A healthy engineering culture treats learning as part of the job, not a side activity. I am more interested in honest fault lines and practical gems than polished success stories. 
Curious engineers who ask good questions will always outperform loud experts who defend fragile certainty.

## Ubuntu, always

>
> **_I am because we are._**
>
